...
<center>
<h1>Coders Cafe</h1>
<a href="SignUp">Register for New users</a>
Sign-In
<form:form action="loginprocess" method="GET" modelAttribute="currentUser">
...
Password<form:input path="password" type="password" name="password" id="password"/>
		<br>
Login As<form:select path="loginAs"	items="${userList}" name="loginAs" id="loginAs"/>
